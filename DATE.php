...
{	
	...
	$message="This is an automated message from sc-media-group.com no need to reply.<br>-------------------------------------------------------<br>
	Your Account Number Is: $accountnumber<br>
	Your Password is: $password<br>
	Email: $email<br>
	--------------------------------------------------------<br>
	To Login to your account <a href='http://sc-media-group.com/customer/prepaid_login_form.php'>Click Here</a>.";
	//$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers = "Content-type: text/html; charset=iso-8859-1" . "\r\n";
	mail($to, $subject, $message, $headers);

	header("location:account_comfirmation.php");
	exit();
  ...
  <tr> 
    <td align="center" valign="top" background="images/GRAYBKG.gif"> 
      ...
      <table width="70%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td><p>Welcome to NicheClips Customer Account Set-up. Open an account
            today <br>
            sc-media-group.com offers Video Clip Download Service and 24 hour Customer Support. <br>
            Please Note:
            All  Accounts are Funded Via Mail Order Only.<br>
              <br>
              sc-media-group.com Does NOT offer DVD sales or provide subscription services. <br>
              sc-media-group.com Does NOT own or produce any of the content available on sc-media-group.com <br>
              </p>
            </td>
        </tr>
      </table>
        ...
        <tr> 
          <th height="307" align="left" valign="top" scope="col"><form name='prepaid_login_form' method="POST" action="" onSubmit="return checkvalidation();">
              <table border="0" align="center" cellpadding="6" cellspacing="0" bordercolor="#666666" id="table1">
                ...
                <tr> 
                  <td align="right" valign="middle"><strong>First Name:</strong> 
                  </td>
                  <td align="left" valign="middle"><input name="FirstName" type="text" class="input_field" size="20"></td>
                </tr>
                <tr> 
                  <td align="right" valign="middle"><strong>Last Name:</strong> 
                  </td>
                ...
                <tr> 
                  ...
                  <td align="left" valign="middle" style="color: #FFFFFF"><input type="text" class="input_field"  name="State" size="20"></td>
                </tr>
                <tr> 
