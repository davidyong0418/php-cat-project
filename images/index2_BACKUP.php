<?php 
	...
	if($per=='1'){
		...
		$query13="select store_id,store_name from store_owner_information where approved='1' and open_date order by open_date DESC LIMIT 0,20";
												...
												<td align="left" valign="top">
													...
													<tr>
														...
														<td colspan="2" align="left" style="padding:1.1px"><img src="images/icon4.gif" width="7" height="7" />
															...
															?>
															<a href="shop.php?store_id=<? echo $row2['store_id']; ?>" onmouseover = 'return overlib("<?php echo "Updated: ".$update . "<br/>" . $img; ?>");' onmouseout="nd();" target="_blank"><? echo $row2['store_name']; ?></a>
														</td>
													  </tr>
												<? 								
													$i++; 
							...
							<tr>
								...
								<form name="f3" id="f3" method = "get">
								  <td align="center" valign="top">
									  ...
									  <input type="submit" class="input_btn" value="Search">
								  </td>
						      </form>
