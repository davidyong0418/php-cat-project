...
if(isset($_REQUEST['submit']))
{
	...
	$curdate=date('d-m-y');
	$query="select itm.client_id,itm.item_name,itm.Date,itm.shopownerprice,soi.commission,soi.global_commission,soi.charge_back,clnt.first_name,clnt.last_name from items as tran,items as itm,store_owner_information as soi,clients as clnt where tran.tr_id=itm.tr_id and itm.store_id='$_SESSION[store_id]' and soi.store_id=itm.Store_id and itm.Date BETWEEN '$year-$month-01' AND '$year-$month-31' and itm.client_id=clnt.id and itm.shopownerprice <>'0'order by itm.Date";
	...
	<tr> 
					  ...
					  <tr> 
						<td height="33" align="left" valign="top" style="padding-right:20px;">Sales for month of: 
						  ...
						  <select name="year" class="input_field">
				                  <option value="2017" selected="selected" <?php if($_REQUEST['year']=='2017'){echo "selected"; }?>>2017</option>
	                                                                              <option value="2018" <?php if($_REQUEST['year']=='2018'){echo "selected"; }?>>2018</option>
		                                                          <option value="2019" <?php if($_REQUEST['year']=='2019'){echo "selected"; }?>>2019</option>
						  </select>
						  &nbsp;&nbsp;
       ...
       <TABLE  width="90%"   border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#999999" bgcolor="#565656">
						  	<TR  class="adminnavileft1">
								...
								<TD align=center background="images/HdrBKG.gif"><B><FONT COLOR="#FFFFFF">Client ID </FONT></B></TD>
