<?php 
	...
	if($per=='1'){
		...
		if(isset($_REQUEST['category']) && $_REQUEST['category'] != ""){
			...
			$query5="select * from store_owner_information as soi where soi.category1='$category' or soi.category2='$_POST[category]' or soi.category3='$_POST[category]' or soi.category4='$_POST[category]' and soi.approved='1'";
			...
			$query5="select * from store_owner_information as soi where soi.category1='$category' or soi.category2='$category' or soi.category3='$category' or soi.category4='$category' and soi.approved='1' LIMIT ". $start .",". $end;
			$result5=mysql_query($query5) or die(mysql_error());
			$count = mysql_num_rows($result5);
			$querynumber = "5";
			...
			$query7="select * from store_owner_information where store_name like '%$_POST[keyword]%' or s_email like '%$_POST[keyword]%'";
			$result7=mysql_query($query7) or die(mysql_error());
			$count=mysql_num_rows($result7);
			$querynumber="7";
		} else if(isset($_REQUEST['keyword_video']) && $_REQUEST['keyword_video']!=""){
			
			$keyword = $_REQUEST['keyword_video'];
			require "Pagination.php";
			
			$query7 = "select * from vedio_clip where description like '%$keyword%'";
			$result7 = mysql_query($query7) or die(mysql_error());
			$count = mysql_num_rows($result7);
			...
			$query7 = "select * from vedio_clip where description like '%$keyword%' LIMIT ". $start .",". $end;
			$result7 = mysql_query($query7) or die(mysql_error());
		...
		$queryfor8='SELECT store_owner_information.store_id, store_owner_information.store_name, sum(total)as \'best_sales\' FROM items, store_owner_information where store_owner_information.store_id=items.store_id and abs(datediff(Date,now()))<10 group by items.store_id order by best_sales desc limit 0,30';
	...
	<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
					...
					<tr>
						<td align="left" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="220" align="left" valign="top" bgcolor="#07183F" style="border-bottom:1px solid #666; border-right:1px solid #666;">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td height="25" align="left" valign="middle" background="images/HdrBKG.gif">
											...
											<tr>
												<td align="left" valign="top">
													<table width="100%" border="0" cellspacing="0" cellpadding="0" id="left-nav">
														<tr>
													...
													<tr>
														...
														<td colspan="2" align="left" style="padding:1.1px"><img src="images/icon4.gif" width="7" height="7" />
															<?php 				 
																$queryClip="select vid.*,str.updated_date from vedio_clip as vid, store_owner_information as str where vid.store_id='$row2[store_id]' and vid.store_id=str.store_id order by vid.id DESC";
																...
																$img = '<img src= \"' . $rowclip['store_id'] . "/clips/files/img_files/". $rowclip['image_file'] .'\" width=\"160\" height=\"120\" border=\"0\">';
																$update=date("m/d/Y",$rowclip['updated_date']);
																mysql_close($resultClip); 
															?>
															<a href="shop.php?store_id=<? echo $row2['store_id']; ?>" onmouseover = 'return overlib("<?php echo "Updated: ".$update . "<br/>" . $img; ?>");' onmouseout="nd();" target="_blank"><? echo $row2['store_name']; ?></a>														</td>
													  </tr>
												<? 								
													$i++; 
												}
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="900" align="left" valign="top" background="images/GRAYBKG.gif"><table width="505" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="505"><img src="images/spacer.gif" width="10" height="10" /></td>
                    </tr>
					...
					<tr> 
                      <td>
						<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
							<tr>
								<form name="f1" action="" method="go">
								<td align="center" valign="top"><br></td>
								</form>
								
								<form name="f3" id="f3" method = "get">
								  <td align="center" valign="top">
									  <span class="style1">Keyword </span><br>
									  <input type = "text" class="txtbox" style="width:150px" name = "keyword_video"/>
									  <input type="submit" class="input_btn" value="Search">								  </td>
						      </form>
							 ...
							 <form name="f2" id="f2">
								  <td align="center" valign="top">
									  ...
									  <select name="storename" class="txtbox" style="width:180px">
										<option value="">Select a Store</option>
										<? while($row4=mysql_fetch_array($result4)){ ?>
										<option value="shop.php?store_id=<? echo $row4['store_id'];?>"><? echo $row4['store_name']; ?> </option>
										<? } ?>
									  </select>
									  <input type="button" class="input_btn" value="Go" onClick="gone()"/>								  </td>
							  </form>
...
<form name="f3" action="" method="post"><input type="hidden" name="keywordsearch" value="keywordsearch"></form></tr></table></td>
                    ...
                    <tr> 
                      <td align="center" valign="top"><div align="center" style="border:#999999 solid 1px;"><table width="100%"border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#000000"  id="mid"> 
							...
							?>
								<tr>
									<td colspan = "2" id = "paginate" style = "text-align: center;padding-top: 10px;padding-bottom: 10px;">
									<?php
 ...
 <?  }
											...
											<table width="450" border="0" cellspacing="0" cellpadding="0">
											   <tr>
													...
													<td width="160" align="right">
														<?php 
															echo $img = '<img src= "' . $row7['store_id'] . "/clips/files/img_files/". $row7['image_file'] .'" width= "80" height= "60" border=\"0\">';
														?>													</td>
													
												 <td width="395" align="left" valign="top" style="padding-top:12px;" id="left-nav">
												   <form style="margin: 0px;" method="post" action="shop.php?store_id=<? echo $row7['store_id']; ?>"  target="_blank" name="f1">
															<input type="hidden" value="<?php echo $row7['id'] ?>" name="clipid"/>
															&nbsp;&nbsp;&nbsp;<input type="submit"  class = "RedClipButton" value="<? echo $row7['title']; ?>" style="width:210px;background-color: black;" name="submitclipid"/>
													   <br/>
													      <?php echo "&nbsp;&nbsp;&nbsp;Price: " .  "<b>" . $row7['price'] . "</b>"; ?>
														  <strong> <br>&nbsp;&nbsp;&nbsp;Keyword: <?php if (isset($_REQUEST['keyword_video'])){ echo $_REQUEST['keyword_video']; } ?></strong><br />
												   </form>												 </td>
											  </tr>
												<tr>
													<td colspan = "2">&nbsp;</td>
                            ...
                            <tr> 
                              <td width="50%" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                  <tr> 
                                    <td colspan="2" align="left" bgcolor="#666666"><div align="center" class="style1"><font size="2">Weekly Top  Shops</font></div></td>
                                  </tr>
                                  <tr> 
							...
							mysql_close($resultClip);
						?>        
									<a href="shop.php?store_id=<? echo $row8['store_id']; ?>" onmouseover="return overlib(' <?php echo "Updated: ".$update; ?> ');" onmouseout="nd();" target="_blank"><? echo $row8['store_name'];?></a></div></td>
                                  </tr>
                                  <?php } ?>
                                </table>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#666666" class="style1">New Shops</td>
    </tr>
	<tr>
    ...
    <td width="90%" align="left"><div style="width:200px; overflow:hidden"><?php 				 
							...
							$update=date("m/d/Y",$rowclip['updated_date']);
							mysql_close($resultClip);
						?>                    <a href="shop.php?store_id=<? echo $row13['store_id']; ?>" onmouseover="return overlib(' <?php echo "Updated: ".$update; ?> ');" onmouseout="nd();" target="_blank"><? echo $row13['store_name']; ?></a></div></td>
                </tr>
                <? $i++; }
				?>
<tr>
...
<input name="hidden2" type="hidden" id="hidden" value="<? echo $i; ?>" />
                                  ...
                                  <tr> 
                                    <td align="center" valign="top" class="redtxt"> 
                                      ...
                                      <form name="f1" action="shop.php?store_id=<? echo $row11['store_id']; ?>" method="post" target="_blank" style="margin:5px;">
                                        <div align="center">
                                          <input type="hidden" name="clipid2" value="<?php echo $row11['id']; ?>" />
                                        <input type="image" src="../<?php echo $row11['store_id']; ?>/clips/files/img_files/<?php echo $row11['image_file']; ?>" width="110" height="65" alt="<?php echo $row11['title']; ?>" title="<?php echo $row11['title']; ?>" ></div>
                                      </form>
                                      <?php } ?></td>
                                    <td align="center" valign="top" class="redtxt"> 
                                      ...
                                      <form name="f1" action="shop.php?store_id=<? echo $row12['store_id']; ?>" method="post" target="_blank" style="margin:5px;">
                                        <div align="center"> 
                                          ...
                                          <input type="image" src="<?php echo $row12['store_id']; ?>/clips/files/img_files/<?php echo $row12['image_file']; ?>" width="110" height="65" alt="<?php echo $row12['title']; ?>" title="<?php echo $row12['title']; ?>" ></div>
                                      </form>
                                      <?php } ?><p></p></td>
                                  </tr>
                                </table></td>
					...
					?>
                    <tr> 
                      <td align="center"><a href="shop.php?store_id=<?php echo $row4banner2['store_id']?>"target="_blank"><br />
                      <img src="<?php echo $path.$row4banner2['banner_file']; ?>" border="0" alt="<?php echo $row4banner2['alt_text']?>" width="468" height="60"></a></td>
                    </tr>
                    <? } ?>
                    <tr> 
                      <td>&nbsp;</td>
        ...
        <td width="220" align="left" valign="top" bgcolor="#07183F" style="border-bottom:1px solid #666; border-left:1px solid #666;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
          ...
          <tr>
            <td align="left" valign="top"><table border="0" cellspacing="0" cellpadding="0" id="left-nav">
                ...
                <tr>
				  ...
				  <form style="margin: 0px;" method="post" action="shop.php?store_id=<? echo $row14['store_id']; ?>"  target="_blank" name="f1">
						<div align="left">
					<?php
					
						$result_vid = mysql_query("select * from vedio_clip as vid where vid.id = '" . $row14['vedioclipid'] . "' order  by vid.id Desc");
						$video_info = mysql_fetch_assoc($result_vid);
						$img = '<img src= \"' . $row14['store_id'] . "/clips/files/img_files/". $video_info['image_file'] .'\" width=\"160\" height=\"120\" border=\"0\">';
					?>
					<input type="hidden" value="<?php echo $row14['vedioclipid'] ?>" name="clipid"/>
					<?php
						$store_name = str_replace("'", "&apos;",$row14['store_name']);			
					?>
					<input type="submit" value="<? echo $row14['item_name']; ?>" class="RedClipButton" style="width:190px" name="submitclipid" onmouseover='return overlib(" <?php  echo "Store: ". $store_name . '<br/>' . $img; ?>", this.style.color="#FFFFCC")' onmouseout="nd(); this.style.color='#FFFFFF'"/></div>
					</form>				  </td>
                </tr>
                <? $i++; }
				?>
  ...
  <tr>
    <td align="left" valign="top"><div align="center">***We are proud to sponsor Crush Talk***<br />
        <a href="" target="_blank"><img src="images/crushtalk_banner.png" alt="Crush Talk were you won&rsquo;t get Banned" width="486" height="82" border="0" /></a><br />
        ***Join in and make new friends!***<br />
        <div>Crush Talk... were you won&rsquo;t get Banned</div>
