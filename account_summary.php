...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
      ...
      <table width="90%" border="1" cellpadding="3" cellspacing="0" bordercolor="#999999" bgcolor="#565656" id="left-nav">
        <tr> 
...
<br>
<table width="90%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#999999" bgcolor="#565656" id="left-nav">
  <tr bgcolor="#000000">
  ...
  <tr> 
    <td height="293" align="left"><strong>Guideline:
      </strong>
      <p><strong>We do not allow any Links or Emails in the Store Header, Description,   Images, Preview Images or anywhere else on your store. Anything containing links or emails will be removed without notice. </strong><br>
        <br>
        <strong>1. For your store to be list on the &quot;Recently Updated Store&quot; 
        listing you must release a New Video Only.<br>
        If you would like to release an older movie it must be accompanied with 
        a brand new movie.<br>
        <br>
        2. One format per Movie, Do not upload multiple formats of the same exact 
        movie. Example AVI Version MPG Version etc.<br>
        <br>
        3. Best of Scenes or Edited Trailers are not accepted for sale.<br>
        <br>
        4. All Movies that have been uploaded to the server must be available 
        for sale. Please do not store files on the server that are not for sale.        </strong> </p>
      <p><strong>If you are 
    uncertain of any guideline please contact us.</strong></p></td>
  </tr>
</table>
