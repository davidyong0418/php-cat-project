					   ...
					   <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
                         ...
                         <tr>
                           <td align="left"><?php 
							...
							echo "Total Payout for this month:   "."$".number_format($total, 2, '.', '');
						?></td>
                         </tr>
                         <tr bgcolor="#990000">
                           <td align="left"><p class="style1">Payouts are sent on the 15th of each month for the previous months sales.</p>
                             <p class="style2"><strong>Please Note: There is a $200 minimum on payouts for Domestic Checks And International Wire Transfers. If your Store does not process $200 in a month we will carry over the amount and send payment, once sales have reached $200 or more.</strong></p>
