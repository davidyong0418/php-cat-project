...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td align="center" valign="top" background="images/GRAYBKG.gif"> <table width="70%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td class="whitetxtcolor"><strong>Welcome to sc-media-group Please Login to Your Account</strong></td>
        </tr>
        <tr>
          <td class="whitetxtcolor">&nbsp;</td>
        </tr>
        <tr>
          <td><span class="whitetxtcolor"><strong>Customers: </strong>Please use your Account Number and Password to login <br>
              <strong>Shop Owners:</strong> Please use your Shop Username and Password to login </span></td>
        </tr>
        <tr>
          <td class="whitetxtcolor">&nbsp;</td>
        </tr>
        <tr> 
          <td class="whitetxtcolor">If you have trouble logging into your account, or would like to open a shop please<strong> <span class="WhiteLinks">
  ...
  document.write("<a href=" + "mail" + "to:" + email + "@" + emailHost+ "?Subject=**sc-media-group%20Support**" + " class=" + "WhiteLinks" + ">" + contact + "</a>" + ".")
  ...
  //-->
        ...
        <tr> 
          <td><p>If you do not have an account, please <a href="http://sc-media-group.com/registration_new_account.php" class="WhiteLinks">Click Here</a> to open one.</p></td>
        </tr>
      </table>
