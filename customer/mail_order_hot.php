...
<table width="70%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td colspan="2" valign="top"><b><span class="txt4">Make all Checks 
                  Payable to "S Productions S " and mail to: </span></b></td>
              </tr>
              <tr>
 ...
 <table width="70%" border="0" cellpadding="4" cellspacing="0" class="border1">
   ...
   <option value="500.00">500.00 
        ...
        <tr>
          <td colspan="3" align="left"><img src="../images/printicon.gif" alt="Print " width="17" height="15" hspace="2" align="absmiddle">If you have trouble printing this form, use our <span class="WhiteLinks"><a href="JavaScript:;" onClick="MM_openBrWindow('mail_order_print_hot.php','PrinterFriendly','width=650,height=550')">Printer-Friendly Version</a></span>.</td>
        </tr>
        <tr> 
