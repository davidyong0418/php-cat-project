...
<tr>
          <td align="right" valign="top" background="../images/GRAYBKG.gif"> <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td><div class="border2" style="padding:5px"><span class="style9">To fund your account by Credit Card: </span>
                  <div id="BalanceBox" style="width:120px" align="center"> <a href="http://66.71.251.130/~crazycol/cart/6_HhhTgd5462456fgsdf245er829845_CFZ_mer6.html" onClick="NewWindow(this.href,'mywin','775','600','no','center');return false" onFocus="this.blur()">Click Here</a></div>
  <br>
  <span class="style9">You will receive a confirmation e-mail 
          notifying you when your funds have been credited to your account. </span><br>
                  <br>
                  <span class="style9">Purchase will be billed as </span><span class="style2">&quot;C-NETWORK&quot;</span><span class="style7">. </span></div></td>
              </tr>
            </table>
            <br>
            <br> 
