...
<tr>
  <td height="400" align="center" valign="top" background="../images/GRAYBKG.gif"> <br>   
    <table width="70%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
		Please download your video clips. <strong>All downloads will expire within 24 hours.</strong> We highly recommend backing up all of your downloaded clips. </td>
      </tr>
    </table>
    <br>
    <TABLE  width="70%"   border="1" cellpadding="2" cellspacing="0" bordercolor="#999999" class="border1">
		...
		<? 
			...
			<tr align="left">
				...
				<TD align=center><span class="WhiteLinks"><A HREF="../DL_FILE_AOL_DOWNLOAD.php?storeowner=<?php echo $row['store_id']; ?>&vedio=<?php echo $row['vedio_file']; ?>&date=<?php echo $row['Download_Date']; ?>">Download</A></span></TD>
			</tr>
		<? }?>
  </table>
    <br>
