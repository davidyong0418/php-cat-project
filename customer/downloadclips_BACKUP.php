...
<tr>
  <td height="400" align="center" valign="top" background="../images/GRAYBKG.gif"> <br>   
    <table width="70%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
                <td> Please download your video clips. <strong>All downloads will 
                  expire within 24 hours.</strong> We highly recommend backing 
                  up all of your downloaded clips. <br>
                  <br>
                  <strong>AOL Users: If you have any difficulties downloading 
  ...
  document.write("<a href=" + "mail" + "to:" + email + "@" + emailHost + "?Subject=***AOL%20User%20Download%20Problem***" +  ">" + contact + "</a>")
    ...
    <TABLE  width="70%"   border="1" cellpadding="2" cellspacing="0" bordercolor="#999999" class="border1">
		...
		<? 
			...
			<tr align="left">
				...
				<TD align=center><span class="WhiteLinks"><A HREF="../DL_FILE.php?storeowner=<?php echo $row['store_id']; ?>&vedio=<?php echo shash_file($row['vedio_file']); ?>&date=<?php echo $row['Download_Date']; ?>">Download</A></span></TD>
			</tr>
		<? }?>
  </table>
    <br>
