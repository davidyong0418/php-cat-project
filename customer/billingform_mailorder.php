...
<tr>
          <td align="right" valign="top" background="../images/GRAYBKG.gif"> <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td align="left" class="whitetxtcolor"><strong>Mail Order funding only </strong></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td><div class="border2" style="padding:5px"> 
                  <p><span class="style2"><blink></blink></span><span class="style4">Funding options now limited to mail order only. We accept Cash or Money Orders. Please <a href="mail_order.php">click here</a> to go to the mail order form. </span> <br>
                    </p>
                  </div></td>
              </tr>
            </table>
