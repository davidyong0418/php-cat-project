...
$query11="select store_id,title,id, image_file from vedio_clip";
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="left-nav">
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" style="padding:1.1px"><img src="images/icon4.gif" width="7" height="7" />
                    <?php 				 
							$queryClip="select vid.*,str.updated_date from vedio_clip as vid, store_owner_information as str where vid.store_id='$row2[store_id]' and vid.store_id=str.store_id";
						...
						?>
                    <a href="shop.php?store_id=<? echo $row2['store_id']; ?>" onmouseover="return overlib(' <?php echo "Total Clips: ".$countClip."<br>"."Updated: ".$update; ?> ');" onmouseout="nd();" target="_blank"><? echo $row2['store_name']; ?></a></td>
                  </tr>
                <? $i++; }
				?>
              </table>
...
mysql_close($queryfor14);
                ...
                <tr>
                  ...
                  <td align="left" valign="middle" style="padding:1px"><form style="margin: 0px;" method="post" action="shop.php?store_id=<? echo $row14['store_id']; ?>"  target="_blank" name="f1">
					...
					<input type="submit" value="<? echo $row14['item_name']; ?>" class="RedClipButton" style="width:190px" name="submitclipid" onmouseover="return overlib(' <?php  echo "Store: ".$row11['image_file'];?>', this.style.color='#FFFFCC')" onmouseout="nd(); this.style.color='#FFFFFF'"/></div>
					</form>
				  </td>
                </tr>
                <? $i++; }
