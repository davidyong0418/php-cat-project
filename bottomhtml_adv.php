...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td></td>
    <td height="20" align="left">&nbsp; <font color="#FBCB03"><strong><?php echo $msg ?></strong></font></td>
  </tr>
  <tr>
    <td></td>
...
<table width="95%" cellpadding="2" cellspacing="0">
                    <tr>
							...
							<tr>
							    ...
							    Advanced Footer HTML Editor:</p>
                                  <p><font color="#CCCCCC">
                                  <textarea name="bottom_html" cols="70" rows="12" id="bottom_html"><? echo $row['b_text']; ?></textarea>
                                    <br>
                                    <br />
                                  <input type="submit" name="submit" value="Save HTML Footer" class="input_btn">
                                      </font></p>
                               <div class="border2" style="width:500px"><br />
                                 <p class="txt4"><span class="redtxt"><strong>*For Basic HTML using our interface</strong></span> <span class="txtbold"><a href="welcome.php?val=footerBas">click here</a>.</span><br /><br />
                                 </p>
                               </div><br><br></td>
							</tr>
					  </table></div>
<!--END ADVANCED EDITOR--></form>
				</td>
  </tr>
  <tr align="left" valign="top">
    <td>&nbsp;</td>
