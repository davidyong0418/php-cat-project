...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
      ...
      <tr>
        <td align="left" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><span class="style1">Manage Products: Edit Clip</span>
        <hr size="1" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="3" id="padding-left">
              ...
              <tr>
                ...
                <td align="left" valign="top" class="style2" id="padding-left">Edit Title:</td>
                <td align="left" valign="top"><input name="title" type="text" class="input_field" value="<?php echo $recordofquery['title']; ?>" size="40" maxlength="40" /></td>
              </tr>
              <tr>
                <td align="left" valign="top" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" valign="middle" class="style2" id="padding-left"><p>Edit Description:</p>
                    <p><font color="#FFFF00">NOTE: Do not add Links or Emails
                      in the Description</font></p></td>
                <td align="left" valign="top"><textarea id="description" name="description" style="height: 170px; width: 420px;" class="input_field"><?php echo $recordofquery['description']; ?>
  ...
  generate_wysiwyg('description');
              ...
              <tr bgcolor="#000000">
                ...
                <td align="left" valign="bottom" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" valign="bottom"><span class="style2">Please DO NOT use any spaces or characters such as ... # $ % ^ * ( ) &quot; &quot; , &lt;&gt; @ % * etc. in the names of your images, previews and video clips files. Please use Alpha Numeric characters Only.</span></td>
              </tr>
              <tr>
                <td align="left" valign="bottom" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" valign="bottom" class="style2" id="padding-left">Edit Clip File:</td>
              ...
              <tr>
                ...
                <td align="left" valign="bottom" class="style2" id="padding-left">Edit Thumb Image:</td>
              ...
              <tr>
                <td align="left" valign="bottom" nowrap="nowrap" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" valign="bottom" class="style2" id="padding-left">Edit Preview Image:</td>
              ...
              <tr>
                ...
                <td align="left" class="style2" id="padding-left">Edit Video Format:</td>
                <td align="left" valign="top"><select name="video_formate" style="" class="input_field">
                  ...
                  <br>
                    ...
                    <option value=".MP4"<?php if($recordofquery['vedio_format']=='.MP4'){ echo "selected";} ?>>MP4</option>
              ...
              <tr>
                <td align="left" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" class="style2" id="padding-left">Edit File Size:</td>
              ...
              <tr>
                <td align="left" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" class="style2" id="padding-left">Edit Running Time:</td>
              ...
              <tr>
                <td align="left" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" class="style2" id="padding-left">Edit Price:</td>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="35%" align="left" valign="top"><select name="price" class="input_field">
                        ...
                        <option value="35.00"<?php if($recordofquery['price']=='35.00'){ echo "selected";} ?>>35.00 </option>
              ...
              <tr>
                <td align="left" class="style2" id="padding-left">&nbsp;</td>
                <td align="left" class="style2" id="padding-left">Edit Available:</td>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
